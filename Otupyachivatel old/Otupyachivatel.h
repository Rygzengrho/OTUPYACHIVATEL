...
// Otupyachivatel.h : main header file for the PROJECT_NAME application
//
...
// COtupyachivatelApp:
// See Otupyachivatel.cpp for the implementation of this class
//

class COtupyachivatelApp : public CWinApp
{
public:
	COtupyachivatelApp();
...
extern COtupyachivatelApp theApp;